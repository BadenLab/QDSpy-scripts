...
p = {"nTrials"         : 10,     # Number of trials (Stimulus loop)
     ...
     "bkgCol_preadapt" : (25,25,25, 25,0,0),       # background color for Pre-Adaptation
...
for iL in range(p["nTrials"]):                                                              # For each Loop:
  ...
  # On
  QDS.SetObjColor(1,[p["StimType"]], [(0,0,0,255,255,255)])                                    # Set Object Colour
  ...
  # On
  QDS.SetObjColor(1,[p["StimType"]], [(0,0,255,0,0,0)])                                  # Set Object Colour
  QDS.SetBkgColor(p["bkgColor"])                                                                    # Set Background Colour
  QDS.Scene_Render(durMarker_s, 1, [p["StimType"]], [(p["x_pos"],p["y_pos"])], 1)                   # Display with trigger
  QDS.Scene_Render(p["OnDur_s"] - durMarker_s, 1, [p["StimType"]], [(p["x_pos"],p["y_pos"])], 0)    # Display without trigger
  ...
  # On
  QDS.SetObjColor(1,[p["StimType"]], [(0,255,0,0,0,0)])                                   # Set Object Colour
  QDS.SetBkgColor(p["bkgColor"])                                                                    # Set Background Colour
  QDS.Scene_Render(durMarker_s, 1, [p["StimType"]], [(p["x_pos"],p["y_pos"])], 1)                   # Display with trigger
  QDS.Scene_Render(p["OnDur_s"] - durMarker_s, 1, [p["StimType"]], [(p["x_pos"],p["y_pos"])], 0)    # Display without trigger
  ...
  # On
  QDS.SetObjColor(1,[p["StimType"]], [(255,0,0,0,0,0)])                                     # Set Object Colour
  QDS.SetBkgColor(p["bkgColor"])                                                                    # Set Background Colour
  QDS.Scene_Render(durMarker_s, 1, [p["StimType"]], [(p["x_pos"],p["y_pos"])], 1)                   # Display with trigger
  QDS.Scene_Render(p["OnDur_s"] - durMarker_s, 1, [p["StimType"]], [(p["x_pos"],p["y_pos"])], 0)    # Display without trigger
